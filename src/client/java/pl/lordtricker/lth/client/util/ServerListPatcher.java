package pl.lordtricker.lth.client.util;

import net.minecraft.client.network.ServerInfo;
import net.minecraft.client.option.ServerList;
import pl.lordtricker.lth.client.mixin.ServerListAccessor;
...
public final class ServerListPatcher {
    ...
    public static void injectOrMove(ServerList serverList) {
        ...
        persist(serverList);
        System.out.println("[LT-ModTemplate] Injected/updated " + address
                + " in server list as '" + displayName + "'");
    }
